...
abstract class AbstractQueryWithLimit<T> extends AbstractQuery<T> {
     ...
     * com.github.deckyfx.greendao.query.QueryBuilder#limit(int)} must
    ...
    /**
     * Sets the offset for results returned by this Query. {@link com.github.deckyfx.greendao.query.QueryBuilder#offset(int)} must
     * have been called on
